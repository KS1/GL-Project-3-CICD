...
def parse_args():
    ...
    parser.add_argument("--model_output", type=str, help="Path of output model")  # Specified the type for model_output
    parser.add_argument('--n_estimators', type=int, default=100,
                        help='The number of trees in the forest')  # Specified the type and default value for n_estimators
